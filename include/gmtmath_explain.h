/*--------------------------------------------------------------------
 *
 *   The GMT-system:	gmtmath_explain.h [Generated by make_gmtmath.x]
 *
 ...
 *--------------------------------------------------------------------*/
/*	gmtmath_explain.h is automatically generated by make_gmtmath.x;
 ...
 */
		...
		fprintf (stderr, "	STEP	1	Heaviside step function H(t-A).\n");
